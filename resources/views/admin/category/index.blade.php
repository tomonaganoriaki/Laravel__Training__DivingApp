    ...
    <div class="py-12 font-bold">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div style="text-align: right; margin-bottom:20px">
                <button class="button" type="button" onclick="location.href='{{ route('admin.category.create') }}'">新規作成</button>
            </div>
            @foreach($categories as $category)
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <p>{{ $category->name }}</p>
                        <button class="button" type="button" onclick="location.href='{{ route('admin.category.edit', $category->id) }}'" style="margin-right: 6px">編集</button>
